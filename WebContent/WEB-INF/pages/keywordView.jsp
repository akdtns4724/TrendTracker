...
<body id="page-top">
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand page-scroll" href="<%=url %>trend/">
				Trend Tracker
			</a>
		</div>
	...
	<div id="nav-content" class="row">
		...
		<div class="col-sm-9">
			...
			<div class="row">
				...
				<div id="geochart_div" class="col-sm-6">
					<table class="table table-striped">
					    <tr>
					        <th>#</th>
					        <th>지역 인기 순위</th>
	...
	<script src="<%=url %>resources/custom/js/keywordView.js"></script>
	<link href="<%=url%>resources/custom/css/keywordView.css" rel="stylesheet">
	<script>
		$(document).ready(function(){
			google.charts.load('current', {packages: ['corechart', 'line']});
			google.charts.setOnLoadCallback(makeChart('${requestScope.keyword.keyword}'));
			
			makeGeoChart('${requestScope.keyword.keyword}');
			makeQueries('${requestScope.keyword.keyword}');
			makeNews('${requestScope.keyword.keyword}');
		});
